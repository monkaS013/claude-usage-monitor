...
**Restrição central (decisão de projeto):** usar SOMENTE o caminho oficial — o Claude Code (≥2.1.80; instalado: 2.1.216) entrega `rate_limits` no stdin do script de statusline. Zero token OAuth, zero endpoint não documentado, zero chamadas de rede.
